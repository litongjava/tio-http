...
public class HttpClientStarter {
  ...
  // 一组连接共用的上下文对象
  public ClientTioConfig tioClientConfig = new ClientTioConfig(httpTioClientHandler, httpTioClientListener, reconnConf);
   ...
   */
  public ClientTioConfig getTioClientConfig() {
  ...
  public static void init() throws Exception {
    ...
    ClientTioConfig tioClientConfig = httpsClientStarter.getTioClientConfig();
   ...
   * @author tanyaowu
   */
  public static void startTest(String serverip, int serverport, String path, int clientCount, int requestCount)
      throws Exception {
    ...
    if (useSsl) {
      ...
      httpClientStarter = com.litongjava.tio.http.client.HttpClientStarter.httpClientStarter;
    }
    ...
    for (int i = 0; i < clientCount; i++) {
      for (int j = 0; j < requestCount; j++) {
        clientHttpRequest.addHeader(HttpConst.RequestHeaderKey.Host,
            clientChannelContextArray[i].getServerNode().getIp());
  ...
  public static void gsOsc() throws Exception {
    ...
    HttpClientStarter httpClientStarter;
    if (useSsl) {
      httpClientStarter = com.litongjava.tio.http.client.HttpClientStarter.httpsClientStarter;
    } else {
      httpClientStarter = com.litongjava.tio.http.client.HttpClientStarter.httpClientStarter;
    }
